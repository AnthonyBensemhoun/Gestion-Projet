...
const TOUR_STEPS=[
  {center:true, title:'Bienvenue 👋 — à quoi sert Helix ?', text:"Helix est l'espace de travail de l'atelier pour <strong>s'organiser, collaborer et gérer les documents qualité</strong>, au même endroit. Fini les fichiers éparpillés et les versions perdues 👋<br><br>Concrètement, Helix réunit : des <strong>projets &amp; tâches</strong> partagés en équipe, le <strong>suivi d'avancement</strong>, et un <strong>circuit documentaire clair</strong> (Rédaction → Revue équipe → Revue QA) avec versions, lecture, commentaires et partage. L'objectif : tout <strong>centraliser, tracer et partager</strong> simplement."},
  {center:true, title:'Comment se passe la visite', text:"On parcourt l'application <strong>onglet par onglet</strong>. Pour que ce soit concret, on crée un <strong>projet</strong> et un <strong>document exemple</strong> (automatiquement <strong>supprimés à la fin</strong> 👌).<br><br>👉 Astuce : appuie sur <strong>Entrée</strong> pour avancer, <strong>Échap</strong> pour quitter."},
  ...
  {sel:'.side-nav .tab[data-tab="portfolio"]', tab:'portfolio', pos:'right', title:'🗂️ Portefeuille', text:"La vue d'ensemble de <strong>tous tes projets</strong> : avancement global, projets en difficulté, et une carte par projet (santé, chef de projet, échéances). Un clic ouvre la synthèse du projet."},
  ...
  {run:()=>closeModal('taskModal'), center:true, last:true, title:'✅ Ça y est, tu es prêt !', text:"Tu sais créer un projet et des tâches, gérer tes documents (lecteur, verrouillage, commentaires) jusqu'au passage en Revue QA / D.O.T, et suivre ton équipe.<br><br>ℹ️ Bon à savoir : la création des <strong>projets suivants</strong> est gérée par ton <strong>Team Leader</strong> (ou un administrateur). Bonne organisation avec Helix 🚀"},
];
